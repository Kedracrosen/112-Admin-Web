                    ...
                    <div class="card auth-card shadow-lg">
                        <div class="card-body">
                                ...
                                <form class="form-horizontal auth-form my-4" action="index.html">
                                    ...
                                    <div class="form-group mb-0 row">
                                        <div class="col-12 mt-2">
                                            <a href="../dashboard/dashboard.html" class="btn btn-danger btn-round btn-block waves-effect waves-light" type="button">Unlock <i class="fas fa-sign-in-alt ml-1"></i></a>
                                        </div>
                                        <!--end col-->
                                    </div>
                                    <!--end form-group-->
                            ...
                            <div class="m-3 text-center text-muted">
                                <p class="">Not you ? return <a href="../authentication/auth-login.html" class="text-danger ml-2">Sign In</a></p>
                            </div>
                        </div>
                        <!--end card-body-->
                    </div>
